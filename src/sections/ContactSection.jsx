    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <a
          ...
          href={`https://wa.me/50581378467?text=${encodeURIComponent(language === 'en' ? 'Hi Maynor, I saw your portfolio and would like to connect.' : 'Hola Maynor, vi tu portafolio y me gustaría conversar contigo.')}`}
          target="_blank"
          rel="noreferrer"
        >
          WhatsApp <ArrowIcon />
