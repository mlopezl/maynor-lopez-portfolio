  ...
  return (
    <section id="inicio" className="relative mx-auto grid min-h-[790px] w-[min(1180px,calc(100%_-_48px))] grid-cols-[1.35fr_.65fr] items-center gap-[8vw] pt-[190px] max-[850px]:min-h-0 max-[850px]:grid-cols-1 max-[850px]:pt-[165px] max-[850px]:pb-[100px] max-[520px]:w-[min(1180px,calc(100%_-_30px))] max-[520px]:pt-[140px]" aria-labelledby="hero-title">
      ...
      <div className="reveal">
        <p className="flex items-center gap-[10px] font-['DM_Mono'] text-[.72rem] uppercase tracking-[.1em] text-[var(--green)]"><span className="size-[7px] rounded-full bg-[var(--green)] shadow-[0_0_14px_var(--green)]" /> Open to web developer opportunities</p>
        <h1 id="hero-title" className="mt-7 mb-[22px] max-w-[820px] text-[clamp(3rem,6.5vw,6.1rem)] leading-[.98] font-medium tracking-[-.065em] max-[520px]:text-[3.2rem]">I build websites <em className="not-italic text-[var(--green)]">that are clear and functional.</em></h1>
        <p className="font-['DM_Mono'] text-[clamp(.78rem,1.1vw,.95rem)] text-[#c6c9d8]">Junior Web Developer · IT Engineering Student</p>
        <p className="mt-[22px] mb-[34px] max-w-[620px] text-[.95rem] leading-[1.75] text-[var(--muted)]">I'm Maynor López. I build responsive interfaces with HTML, CSS, JavaScript and React.</p>
        <div className="flex flex-wrap gap-3"><a className="inline-flex min-h-[47px] items-center justify-center gap-[10px] rounded-[3px] border border-[var(--green-strong)] bg-[var(--green-strong)] px-5 text-[.82rem] font-semibold text-[#090b15] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--green)] max-[520px]:flex-1" href="#proyectos">View projects <ArrowIcon /></a><a className="inline-flex min-h-[47px] items-center justify-center gap-[10px] rounded-[3px] border border-[var(--line)] px-5 text-[.82rem] font-semibold transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--accent)] max-[520px]:flex-1" href="https://github.com/mlopezl" target="_blank" rel="noreferrer"><GitHubIcon /> GitHub</a></div>
      </div>
